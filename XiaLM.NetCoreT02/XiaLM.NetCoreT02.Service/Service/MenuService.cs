...
namespace XiaLM.NetCoreT02.Service.Service
{
    public class MenuService : IMenuService
    {
        ...
        public MenuService(IMenuRepository menuRepository, IUserRepository userRepository, IRoleRepository roleRepository)
        {
